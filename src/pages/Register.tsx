...
export const Register = () => {
  ...
  const validateForm = () => {
    ...
    if (formData.password.length < 6) {
      toast.error(language === "en" ? "Password must be at least 6 characters" : "Senha deve ter pelo menos 6 caracteres");
      return false;
    }
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      placeholder={language === "en" ? "Create a password (min. 6 characters)" : "Crie uma senha (mín. 6 caracteres)"}
