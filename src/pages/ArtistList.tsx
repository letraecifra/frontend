...
export const ArtistList = () => {
  ...
  const [sortBy, setSortBy] = useState<"name" | "songs" | "likes">("name");
          ...
          <CardContent className="pt-6">
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="relative flex-1">
                ...
                <Input
                  type="search"
                  placeholder={language === "en" ? "Search artists or genres..." : "Buscar artistas ou gêneros..."}
                  value={searchQuery}
                  ...
                  <CardContent className="p-6 text-center">
                    ...
                    <div className="space-y-2 text-sm text-muted-foreground">
                      <div className="flex items-center justify-center space-x-1">
                        ...
                        <span>{artist.songCount} {language === "en" ? "songs" : "músicas"}</span>
                      </div>
                      <div className="flex items-center justify-center space-x-1">
                        <TrendingUp className="w-3 h-3" />
                        <span>{artist.totalLikes.toLocaleString()} {language === "en" ? "likes" : "curtidas"}</span>
                      </div>
                    </div>
