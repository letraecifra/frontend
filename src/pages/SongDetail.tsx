...
export function SongDetail(): ReactNode {
  useParams(); // FIXME: get song id from URL
  ...
  function handleContentChange(newContent: string, newKey: string): void {
  ...
  return (
    <div className="min-h-screen bg-gradient-secondary">
      ...
      <div className="container mx-auto px-4 py-8">
        <Link
          to="/"
          className="inline-flex items-center text-muted-foreground hover:text-primary transition-colors ease-musical mb-6"
        >
            ...
            <Card className="bg-gradient-card shadow-card">
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
                  ...
                  <span>
                    {language === 'en' ? 'Comments' : 'Comentários'} ({comments.length})
                  </span>
                </CardTitle>
              </CardHeader>
                  ...
                  <Textarea
                    placeholder={
                      language === 'en'
                        ...
                        : 'Compartilhe sua opinião sobre esta música...'
                    }
                    value={newComment}
          ...
          <div className="space-y-6">
              ...
              <CardContent className="space-y-3 text-sm">
                <div className="flex justify-between">
                  <span className="text-muted-foreground">
                    {language === 'en' ? 'Added by:' : 'Adicionado por:'}
                  </span>
                ...
                <div className="flex justify-between">
                  <span className="text-muted-foreground">
                    {language === 'en' ? 'Added on:' : 'Adicionado em:'}
                  </span>
                ...
                <div className="flex justify-between">
                  <span className="text-muted-foreground">
                    {language === 'en' ? 'Original Key:' : 'Tom Original:'}
                  </span>
            ...
            <Card className="bg-gradient-card shadow-card">
              ...
              <CardContent className="space-y-3">
                {['Working Class Hero', 'Give Peace a Chance', 'Instant Karma'].map(
                  (songTitle, index) => (
                    <Link
                      key={index}
                      to={`/song/${index + 10}`}
