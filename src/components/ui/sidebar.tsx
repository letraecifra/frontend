...
SidebarProvider.displayName = SidebarProvider.name;
Sidebar.displayName = Sidebar.name;
SidebarTrigger.displayName = SidebarTrigger.name;
SidebarRail.displayName = SidebarRail.name;
SidebarInset.displayName = SidebarInset.name;
SidebarInput.displayName = SidebarInput.name;
SidebarHeader.displayName = SidebarHeader.name;
SidebarFooter.displayName = SidebarFooter.name;
SidebarSeparator.displayName = SidebarSeparator.name;
SidebarContent.displayName = SidebarContent.name;
SidebarGroup.displayName = SidebarGroup.name;
SidebarGroupLabel.displayName = SidebarGroupLabel.name;
SidebarGroupAction.displayName = SidebarGroupAction.name;
SidebarGroupContent.displayName = SidebarGroupContent.name;
SidebarMenu.displayName = SidebarMenu.name;
SidebarMenuItem.displayName = SidebarMenuItem.name;
SidebarMenuButton.displayName = SidebarMenuButton.name;
SidebarMenuAction.displayName = SidebarMenuAction.name;
SidebarMenuBadge.displayName = SidebarMenuBadge.name;
SidebarMenuSkeleton.displayName = SidebarMenuSkeleton.name;
SidebarMenuSub.displayName = SidebarMenuSub.name;
SidebarMenuSubItem.displayName = SidebarMenuSubItem.name;
SidebarMenuSubButton.displayName = SidebarMenuSubButton.name;
